    ...
    def form_valid(self, form):
        ...
        if cart_id:
            ...
            if pm == "Khalti":
                ...
                return redirect(reverse("mainapp:esewarequest") + "?o_id=" + str(order.id))
        else:
...
class PasswordResetView(FormView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if user is not None and password_reset_token.check_token(user, token):
            ...
            return redirect(reverse("mainapp:passworforgot") + "?m=e")
...
class AdminOrderStatuChangeView(AdminRequiredMixin, View):
    def post(self, request, *args, **kwargs):
        ...
        order_obj.save()
        return redirect(reverse_lazy("mainapp:adminorderdetail", kwargs={"pk": order_id}))
...
class AdminProductCreateView(AdminRequiredMixin, CreateView):
    ...
    success_url = reverse_lazy("mainapp:adminproductlist")
...
def payment(request):
    if request.method == 'POST':
        form = paymentForms(request.POST or None)
        if form.is_valid():
            form.save()
            form = paymentForms()
